...
modulator_frequency = float(input('Enter Modulator_frequency: '))
carrier_frequency = float(input('Enter carrier frquency: '))
modulation_index = float(input('Enter Modulation_index: '))
